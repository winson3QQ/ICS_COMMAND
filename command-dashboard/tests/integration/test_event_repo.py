...
class TestEventStateMachine:
    def test_open_to_in_progress(self, tmp_db):
        from repositories.event_repo import create_event, get_events, update_event_status
...
class TestAddEventNote:
    def test_note_appended(self, tmp_db):
        from repositories.event_repo import add_event_note, create_event, get_events
