...
echo "  0b. Marti REST 讀寫（#177 L1）：cert 經 step-ca 簽即受 truststore 信任、可讀（毋須註冊）；"
echo "      寫入需 mission owner role（P2-13 待解）。設 TAK_MARTI_READ_CERT/KEY、TAK_MARTI_WRITE_CERT/KEY。"
